...
/*************************************************************************************************/
  ...
  /**************************************************************************************/
    ...
    /*******************************    MSP ONLY    ************************************/
      // uncomment if controlling only via MSP 200
      #define MSPRXONLY
 ...
 */
  ...
  /**************************************************************************************/
   ...
   /* GPS protocol 
    ...
    #define MAG_DECLINATION  4.18f   //(**)

    //#define GPS_LEAD_FILTER                      // Adds a forward predictive filterig to compensate gps lag. Code based on Jason Short's lead filter implementation
    
    //#define GPS_FILTERING                        // add a 5 element moving average filter to GPS coordinates, helps eliminate gps noise but adds latency comment out to disable
    #define GPS_WP_RADIUS              50       // if we are within this distance to a waypoint then we consider it reached (distance is in cm)
    #define NAV_SLEW_RATE              20        // Adds a rate control to nav output, will smoothen out nav angle spikes
